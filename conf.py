...
# APhotoBlog options
aphotoblog_page_size = 10
# aphotoblog_photo_page_size = 20
...
parlante_ping_snippet = f"""
    ...
    <script src="{parlante_url}/parlante.js" async onload="parlanteGetPingMeForm('{parlante_url}', '{parlante_client_id}', 'contact-container')"></script>

"""
rst_epilog = f"""
.. |parlante_pingme| raw:: html

    {parlante_ping_snippet}
"""
...
blog_title = "Porão do Juca"

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = "https://poraodojuca.dev"
# blog_baseurl = "http://localhost:8080"
...
vblog_authors = {
    "Juca Crispim": ("Juca Crispim", None),
}
...
post_date_format = 'publicado em %d de %B de %Y'
...
project = "Porão do Juca"
year = datetime.now().year
copyright = f"2009-{year}, Juca Crispim"
author = "Juca Crispim"
...
htmlhelp_basename = "PorodoJucadoc"

html_css_files = [
    'css/blog.css',
    ('css/blog-darker.css', {'media': '(prefers-color-scheme: dark)'}),
]
